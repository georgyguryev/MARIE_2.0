classdef tfqmr_solver < src_solver.solver
    ...
    methods
        ...
        function obj = tfqmr_solver(mvp, precond,  max_iter, tolerance, precond_type, dims)
    ...
    methods (Access = protected)
        ...
        function setup_solver_(obj)
            ...
            obj.iterative_solver = @(rhs, ini_guess)  src_numeric.my_tfqmr(@(Jin) obj.mvp(Jin), rhs, obj.tolerance, obj.max_iter, Lp, Up, Pp, ini_guess);
