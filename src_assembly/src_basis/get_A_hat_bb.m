function [A_hat_out] = get_A_hat_bb(rows, cols, task_settings, scatterer, coil, dims, freq, op_type)
...
switch op_type
    case 'N'                                                
        [A_hat_N, ~] = src_coupling.assemble_coupling_matrices(task_settings, scatterer, coil, dims, freq, cols, I_vox, 1);
        A_hat_N = P_mask * A_hat_N;
    case 'K'
        [~, A_hat_K] = src_coupling.assemble_coupling_matrices(task_settings, scatterer, coil, dims, freq, cols, I_vox, 1);
