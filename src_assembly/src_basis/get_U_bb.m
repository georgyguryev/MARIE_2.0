function [U_out] = get_U_bb(cols, task_settings, scatterer, coil, dims, freq, op_type)
...
switch op_type
    case 'N'
        [U_N, ~] = src_coupling.assemble_coupling_matrices(task_settings, scatterer, coil, dims, freq, cols, [], 1);
    case 'K'
        [~, U_K] = src_coupling.assemble_coupling_matrices(task_settings, scatterer, coil, dims, freq, cols, [], 1);
    otherwise
        [U_N, U_K] = src_coupling.assemble_coupling_matrices(task_settings, scatterer, coil,  dims, freq, cols, [], 1);
end
