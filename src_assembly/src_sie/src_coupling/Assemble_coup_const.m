function [Zbc_const] = Assemble_coup_const(R1,R2,R3,RO,NO,IDX,L1,ko,res,Np_2D,Z1,Z2,Z3,wp,GL_VIE_order, idx_imp_near)
...
Nvie = length(z_vie_far);   % get number of quadrature points in VIE 1D 
