function I_ST = singular_ST_lin(l,lp,k0,dx,Np,ker_type,np,nq,r1,r2,r3,r4)
...
% r1,r2,r3,r4 : (3x1) ordered points according to DIRECTFN's logic

% I_ST        : complex double self term singular integral
...
%% call C++ mex file to calculate Self Term singular integral

% centre of squares
rq_c = (r1 + r3)/2;

I_ST = solve_st(r1,r2,r3,r4,Np,Np,Np,Np,k0,dx,rq_c,rq_c,nq,np,ker_type,l,lp);
